...
Отримати практичний досвід розгортання веб-застосунку в production середовищі, ознайомитись з інструментами веб-майстра
та на власному прикладі побачити як пошукові системи взаємодіють з сайтом побудованим на Client-side rendering (CSR)
архітектурі.
...
- Взяти проект новинного курсу "Фреймворки JavaScript" (React або Vue)
- Переконатись що проект запускається локально
- Створити репозиторій на GitHub якщо його ще немає
- Додати `README.md` з описом проекту

```bash
# Перевірка що проект працює
npm install
npm run dev
```
...
### 2. Розгортання на Railway *(20 хв)*

- Зареєструватись на [railway.app](https://railway.app) через GitHub
- Створити новий проект: `New Project → Deploy from GitHub repo`
