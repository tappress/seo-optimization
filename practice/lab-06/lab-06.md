...
| Screaming Frog SEO Spider  | Технічний crawl, статус-коди, canonical, редіректи | screamingfrog.co.uk/seo-spider      |
...
- Чи валідна Schema.org розмітка (Rich Results Test)
...
Вибрати мінімум **3 шаблони сторінок**:

- Головна
- Одна категорія/листинг
- Одна стаття/товар
...
Для кожного URL виписати топ-3 проблеми з розділів **Opportunities** та **Diagnostics**:
...
Виконати практичні оптимізації і повторно виміряти метрики. Мінімальна вимога - **5 впроваджених змін**:

- мінімум 2 зміни для LCP
...
Проаналізувати мінімум **20 зовнішніх посилань** і класифікувати:
...
**Мінімальна вимога:** знайти **30 доменів-можливостей** (prospects) і розставити пріоритети.
...
|---------|------|---------------|-----|---------------|
| Приклад | Аудит і пріоритезація | Зібрати baseline профілю, перевірити анкори, сформувати список 30 prospect-доменів | 30 prospect-доменів, 1 затверджений backlog | SEO lead + outreach |
...
5. Показники Core Web Vitals до/після оптимізації (мін. 3 URL)
6. Список впроваджених оптимізацій швидкості (мін. 5)
7. Backlink аналіз мінімум 20 посилань з оцінкою якості
8. Backlink gap таблиця з мін. 30 можливостями
...
| Виправлення технічних помилок (мін. 6)                  | 2      |
| Аналіз швидкості (baseline для 3 URL, mobile + desktop) | 1      |
| Оптимізація Core Web Vitals (мін. 5 змін, до/після)     | 2      |
| Аналіз backlink профілю (мін. 20 посилань)              | 1      |
| Backlink gap + link strategy на 30 днів                 | 2      |
| **Разом**                                               | **10** |
